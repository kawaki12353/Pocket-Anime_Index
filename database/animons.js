const animons = [      
 ...
 {id:2.01,name:"Super Bojin",type:"Psychic",sprite:"assets/animons-icon/super_bojin.png",stats:{hp:80,atk:39,def:67,spAtk:90,spDef:49,spd:63},movesList: [{level:1, name:"Energy Blast"}, {level:1, name:"Energy Charge"}, {level:4, name: "Solar Flare"}, {level:6, name:"Vanishing Blow"}, {level:12, name:"Drain Life"}, {level:24, name:"Limb Regrowth"}]},
