...
{rarity:"incomum",
 pt:{name:"Plain Cloth",desc:"Um simples rolo de tecido, versátil e sem adornos.",drop:"Derrotando Animons do tipo Neutral.",cat:"evolution"},
 en:{name:"Plain Cloth",desc:"A simple roll of cloth, versatile and unadorned.",drop:"Defeating Neutral-type Animons.",cat:"evolution"},
},
{rarity:"raro",
 pt:{name:"Tide Crystal",desc:"Um cristal azul profundo com camadas que imitam as profundezas tranquilas do oceano.",drop:"Derrotando Animons do tipo Water.",cat:"evolution"},
 en:{name:"Tide Crystal",desc:"A deep blue crystal with layers that mimic the tranquil depths of the ocean.",drop:"Defeating Water-type Animons.",cat:"evolution"},
},
{rarity:"comum",
...
{rarity:"lendario",
 pt:{name:"Z-Capsule",desc:"Uma das tecnologias de cápsula mais populares, esta cápsula concede a habilidade de capturar Animons selvagens!",note:"x2 a Chance de Captura.",drop:"Limitado a fase 2 de Testes.",cat:"capture"},
...
{rarity:"incomum",
 pt:{name:"Aqua Gem",desc:"Uma joia azul e transparente que abriga em seu interior um pequeno vórtice giratório de água pura.",drop:"Derrotando Animons do tipo Water.",cat:"evolution"},
...
{rarity:"raro",
 pt:{name:"Demon Essence",desc:"Fornecida por demônios poderosos.",drop:"Derrotando Animons do tipo Demon.",cat:"evolution"},
...
{rarity:"raro",
 pt:{name:"Enchanted Fabric",desc:"Rolos de tecido mítico, tecidos com fios que pulsam com poder mental.",drop:"Derrotando Animons do tipo Psychic.",cat:"evolution"},
...
{rarity:"incomum",
 pt:{name:"Fiend Claw",desc:"Uma garra afiada e ameaçadora de um demônio menor, infundida com poder sombrio.",drop:"Derrotando Animons do tipo Demon.",cat:"evolution"},
...
{rarity:"incomum",
 pt:{name:"Frost Shard",desc:"Um fragmento de gelo elegante e afiado, imbuído com a essência do frio.",drop:"Derrotando Animons do tipo Ice.",cat:"evolution"},
...
{rarity:"epico",
 pt:{name:"King's Pincer",desc:"Uma pinça enorme e irregular do lendário Rei Caranguejo, imbuída com poder e resistência incomparáveis.",drop:"Derrotando Animons do tipo Fighting.",cat:"evolution"},
...
{rarity:"epico",
 pt:{name:"Magma Crystal",desc:"Um fragmento enigmático moldado por forças vulcânicas, brilhando com núcleos derretidos e manchas flamejantes.",drop:"Derrotando Animons do tipo Fire. Derrotando o Animon Dinossaur.",cat:"evolution"},
...
{rarity:"incomum",
 pt:{name:"Mind Thread",desc:"Um carretel de linha roxa cintilante, irradiando energia psíquica.",drop:"Derrotando Animons do tipo Psychic.",cat:"evolution"},
...
{rarity:"incomum",
 pt:{name:"Mystic Tablet",desc:"Uma antiga tábua de bronze gravada com runas misteriosas.",drop:"Derrotando Animons do tipo Soul.",cat:"evolution"},
...
{rarity:"epico",
 pt:{name:"Pure Sphere",desc:"Uma esfera perfeitamente lisa e translúcida, irradiando uma energia suave e equilibrada.",drop:"Derrotando Animons do tipo Neutral.",cat:"evolution"},
...
{rarity:"incomum",
 pt:{name:"Shadow Fang",desc:"Um osso simples e pálido imbuído de energia sombria.",drop:"Derrotando Animons do tipo Dark.",cat:"evolution"},
 en:{name:"Shadow Fang",desc:"A simple, pale bone imbued with dark energy.",drop:"Defeating Dark-type Animons.",cat:"evolution"}
},
{rarity:"incomum",
 pt:{name:"Spark Gem",desc:"Uma joia roxa vibrante contendo uma pequena nuvem de tempestade ativa, com relâmpagos visíveis em seu interior.",drop:"Derrotando Animons do tipo Lightning.",cat:"evolution"},
...
{rarity:"raro",
 pt:{name:"Stone Slab",desc:"Uma placa de pedra robusta e sem marcas, carregando uma energia simples, porém sólida.",drop:"Derrotando Animons do tipo Neutral.",cat:"evolution"},
...
{rarity:"incomum",
 pt:{name:"Terra Shards",desc:"Fragmentos resistentes da terra, sólidos e confiáveis.",drop:"Derrotando Animons do tipo Earth.",cat:"evolution"},
...
{rarity:"epico",
 pt:{name:"Thunder Orb",desc:"Um grande orbe roxo radiante que encapsula uma tempestade elétrica eternamente ativa.",drop:"Derrotando Animons do tipo Lightning.",cat:"evolution"},
...
{rarity:"incomum",
 pt:{name:"Venom Vial",desc:"Um pequeno frasco contendo um líquido verde vibrante que borbulha de forma ameaçadora.",drop:"Derrotando Animons do tipo Poison.",cat:"evolution"},
...
{rarity:"incomum",
 pt:{name:"Warrior Horn",desc:"Um chifre robusto que pertenceu a uma besta feroz, transbordando espírito de luta.",drop:"Derrotando Animons do tipo Fighting.",cat:"evolution"},
...
{rarity:"incomum",
 pt:{name:"Green Bean",desc:"Um feijão verde estranho! Possui propriedades curativas e também cura se o HP cair para 30%!",note:"Recupera 25 de HP.",drop:"Loja da Torre do Korin",cat:"medical"},
...
{rarity:"raro",
 pt:{name:"Dashfruit",desc:"Cítrica e leve — uma mordida e você já está em movimento!",note:"Aumenta o SPD TV em 10",drop:"Loja de Fase",cat:"status"},
...
{rarity:"raro",
 pt:{name:"Dragfruit",desc:"Pesada e lenta, seu peso parece te puxar para trás a cada mordida.",note:"Diminui o SPD TV em 10",drop:"Loja de Fase",cat:"status"},
...
{rarity:"comum",
 pt:{name:"GX-Attack",desc:"Um acelerador metabólico de assimilação rápida da Gamyng Corp, criado para aumentar drasticamente o ataque dos Animons.",drop:"Lojas",cat:"misc"},
...
{rarity:"comum",
 pt:{name:"GX-Defense",desc:"Um acelerador metabólico de assimilação rápida da Gamyng Corp, criado para aumentar drasticamente a defesa dos Animons.",drop:"Lojas",cat:"misc"},
...
{rarity:"comum",
 pt:{name:"GX-Special Atk",desc:"Um acelerador metabólico de assimilação rápida da Gamyng Corp, criado para aumentar drasticamente o ataque especial dos Animons.",drop:"Lojas",cat:"misc"},
...
{rarity:"comum",
 pt:{name:"GX-Special Def",desc:"Um acelerador metabólico de assimilação rápida da Gamyng Corp, criado para aumentar drasticamente a defesa especial dos Animons.",drop:"Lojas",cat:"misc"},
...
{rarity:"comum",
 pt:{name:"GX-Speed",desc:"Um acelerador metabólico de assimilação rápida da Gamyng Corp, criado para aumentar drasticamente a velocidade dos Animons.",drop:"Lojas",cat:"misc"},
...
{rarity:"raro",
 pt:{name:"Gilded Sidearm",desc:"Aumenta o Dano de Arma em 1.2x",drop:"Baú no labirinto do Palácio",cat:"battle"},
...
{rarity:"incomum",
 pt:{name:"S-Potion",desc:"Uma versão aprimorada da C-Potion.",drop:"Lojas",cat:"medical"},
 en:{name:"S-Potion",desc:"An upgraded version of the C-Potion.",drop:"Shops",cat:"medical"}
},
{rarity:"raro",
 pt:{name:"Seismic Buckler",desc:"Reduz o dano do tipo Earth em 1.2x",drop:"Baú no Palácio",cat:"battle"},
 en:{name:"Seismic Buckler",desc:"Reduces Earth damage by 1.2x",drop:"Chest in the Palace",cat:"battle"},
 icon:"seismic_buckler.png"
},
{rarity:"comum",
 pt:{name:"Smoke Bomb",desc:"Este item possui a habilidade de te teleportar para a sua última visita a uma anistation!",drop:"Lojas",cat:"misc"},
 en:{name:"Smoke Bomb",desc:"This item has the ability to teleport you to your last anistation visit!",drop:"Shops",cat:"misc"},
 icon:"smoke_bomb.png"
},
{rarity:"raro",
 pt:{name:"Stonefruit",desc:"Pesada e densa. Comê-la faz você se sentir como uma parede.",note:"Aumenta o DEF TV em 10",drop:"Loja de Fase",cat:"status"},
...
{rarity:"raro",
 pt:{name:"Weighted Clothes",desc:"Dobra a quantidade de TVs ganhas após derrotar um oponente.",drop:"Fighter Crate",cat:"battle"},
...
{rarity:"raro",
 pt:{name:"Wispmelon",desc:"Suave e reconfortante, este melão acalma e protege a alma!",note:"Aumenta o SP DEF TV em 10",drop:"Loja de Fase",cat:"status"},
...
{rarity:"incomum",
 pt:{name:"Wolf Fang",desc:"Uma presa elegante e extremamente afiada de um lobo formidável, um claro testemunho da natureza selvagem indomável.",drop:"Derrotando Battle Wolf ou Teen Battle Wolf",cat:"misc"},
...
{rarity:"comum",
 pt:{name:"Cloth Rags",desc:"Alguns trapos usados por bandidos... parecem bem inúteis para mim.",drop:"Derrotando o Animon Bandit",cat:"misc"},
 en:{name:"Cloth Rags",desc:"Some rags worn by bandits... looks pretty useless to me.",drop:"Defeating the Bandit Animon",cat:"misc"}
},
{rarity:"incomum",
 pt:{name:"Scarf",desc:"[Sem Descrição]",drop:"Derrotando o Animon Wolfman",cat:"misc"},
 en:{name:"Scarf",desc:"[No Description]",drop:"Defeating the Wolfman Animon",cat:"misc"}
},
{rarity:"comum",
 pt:{name:"Shell Casings",desc:"Parece ser algum tipo de munição usada pela Marinha! Também bem inútil.",drop:"Lojas",cat:"misc"},
...
{rarity:"epico",
 pt:{name:"Beast Talisman",desc:"Um talismã gravado em carmesim que, ao ser usado no Animon escolhido com Fox Spirit, desperta sua forma Beast e libera um poder adormecido.",drop:"Bandit Crate",cat:"battle"},
...
{rarity:"epico",
 pt:{name:"Tempest Quills",desc:"Duas penas escuras e resistentes, amarradas juntas, impregnadas com a força de uma tempestade furiosa.",drop:"Derrotando Animons do tipo Wind.",cat:"evolution"},
...
{rarity:"epico",
 pt:{name:"Demonic Blade",desc:"A Lâmina Demoníaca, envolta em mistério e trevas, é uma arma que prospera no calor da batalha!",note:"Derrote Animons para aumentar o dano das habilidades de espadachim! [1.2x-1.8x]",drop:"Fishing Crate",cat:"battle"},
...
{rarity:"epico",
 pt:{name:"Mysterious Egg",desc:"Um ovo misterioso e enigmático...",drop:"Quest em Great Plains",cat:"key"},
...
{rarity:"comum",
 pt:{name:"Missing Shipments",desc:"Restos desaparecidos! Por algum motivo, os alienígenas selvagens são atraídos por isso.",drop:"Derrotando o Animon Alien.",cat:"misc"},
...
{rarity:"incomum",
 pt:{name:"Shadow Bone",desc:"[Sem Descrição ainda]",drop:"???",cat:"evolution"},
 en:{name:"Shadow Bone",desc:"[No description yet]",drop:"???",cat:"evolution"}
},
{rarity:"incomum",
 pt:{name:"Storm Battery",desc:"Uma bateria que absorve eletricidade estática do ar, aumentando o poder dos golpes do tipo Elétrico!",drop:"Loja em Capsule City",cat:"battle"},
...
{rarity:"epico",
 pt:{name:"Abyssal Eye",desc:"Um olho grande e ameaçador, com um olhar penetrante, pulsando com energia malévola.",drop:"Derrotando Animons do tipo Demon.",cat:"evolution"},
...
{rarity:"raro",
 pt:{name:"Merciful Blow Scroll",desc:"Uma técnica misericordiosa, que só pode ser aprendida por espadachins específicos.",note:"Aprende o ataque Merciful Blow, que ao atacar, impede o alvo de ser derrotado. O alvo fica com pelo menos 1 de HP.",drop:"15k na Loja em Capsule City ou Highstar Base Crate.",cat:"scroll"},
...
{rarity:"raro",
 pt:{name:"Earth Blocks",desc:"Blocos densos de terra comprimida, impregnados de energia elemental.",drop:"Derrotando Animons do tipo Earth.",cat:"evolution"},
 en:{name:"Earth Blocks",desc:"Dense blocks of compressed earth, infused with elemental energy.",drop:"Defeating Earth-type Animon.",cat:"evolution"}
},
{rarity:"epico",
 pt:{name:"Ancient Stone",desc:"Pedras antigas e robustas que guardam o poder do núcleo da Terra.",drop:"Derrotando Animons do tipo Earth.",cat:"evolution"},
 en:{name:"Ancient Stone",desc:"Sturdy, ancient stones that hold the power of the earth's core.",drop:"Defeating Earth-type Animon.",cat:"evolution"}
},
{rarity:"raro",
 pt:{name:"Seastone Cuff",desc:"Algemas feitas com pedra especial! Podem ferir usuários de elementos.",note:"[Sobre o Efeito, estará aqui quando o jogo voltar.]",drop:"Marine Crate",cat:"battle"},
 en:{name:"Seastone Cuff",desc:"Cuffs made with special stone! Can damage elemental users.",note:"[Regarding the effect, it will be here when the game returns.]",drop:"Marine Crate",cat:"battle"}
}
];